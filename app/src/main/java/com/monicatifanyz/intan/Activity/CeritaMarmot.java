...
public class CeritaMarmot extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cerita_marmot);
    ...
    public void prev(View view){
        Intent sebelum = new Intent(this, AwalEval.class);
